...
|---|---------|-------------|-----|
| 1 | 🤖 **[Agent-Board](https://agentboard.ayande.xyz)** | OpenSource TUI multi-coding-agent workflow | [📦]() |
| 2 | 🧠 **[Freecode](https://freecode.ayande.xyz)** | Free AI coding agent | [📦]() |
| 3 | 🎓 **[openscrim](https://openscrim.ayande.xyz)** | OpenSource alternative to Scrimba | [📦]() |
| 4 | 🔄 **[contextcarry](https://cc.ayande.xyz)** | Carry your context across sessions and agents + MCP | [📦]() |
| 5 | 🛡️ **[secureclaw](https://secureclaw.ayande.xyz)** | OpenClaw secured version |[📦]() |
| 6 | ⚙️ **[noheadacenode](https://ayande.xyz)** | Express-like framework with file-based routing and more | [📦]() |
| 7 | 🔐 **[sso-node](https://ssonode.ayande.xyz)** | NPM package for SSO implementation | [📦]() |
| 8 | 🚀 **[rzd](https://ayande.xyz)** | NPM package to prevent React chunk errors | [📦]() |
